---
title: "A minimalist example deployed locally"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{A minimalist example deployed locally}
...
familiarized with the concepts and functions. This method is applicable for
building data products on locally or on mounted drives. 
...
the getting started [vignette](https://amashadihossein.github.io/daapr/articles/daapr.html) 
for details of what the initialization does.

Note: when providing board params to `board_params_set_local`, make sure to specify 
an absolute path for "folder", NOT a path relative to your current path. 
