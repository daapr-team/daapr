...
This function tries to provide a more sensible mapping of names to their
code friendly version than make.names

## Usage

``` r
make_names_codefriendly(x, make_unique = TRUE)
```
